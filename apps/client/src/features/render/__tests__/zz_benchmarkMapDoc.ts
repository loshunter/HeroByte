...
export function buildBenchmarkDocument(): MapDocument {
  ...
  return {
    ...
    layers: [
      { id: "background", name: "Background", kind: "background", visible: true, locked: true, opacity: 1, zIndex: 0 },
      { id: "terrain", name: "Terrain", kind: "terrain", visible: true, locked: false, opacity: 1, zIndex: 10 },
      { id: "objects", name: "Objects", kind: "objects", visible: true, locked: false, opacity: 1, zIndex: 20 },
      { id: "walls", name: "Walls & Doors", kind: "walls", visible: true, locked: false, opacity: 1, zIndex: 30 },
      { id: "lighting", name: "Lighting", kind: "lighting", visible: true, locked: false, opacity: 1, zIndex: 40 },
      { id: "notes", name: "GM Notes", kind: "notes", visible: true, locked: false, opacity: 1, zIndex: 50 },
    ],
    elements,
    terrain,
    revision: 0,
