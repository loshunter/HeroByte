    ...
    <button
      ...
      onMouseEnter={(e) => {
        if (!disabled) {
          ...
          e.currentTarget.style.boxShadow = '0 8px 0 var(--hero-navy-dark), 0 0 16px rgba(68,125,247,0.7)';
        }
      }}
      onMouseLeave={(e) => {
        if (!disabled) {
          e.currentTarget.style.transform = 'translateY(0)';
          e.currentTarget.style.boxShadow = '0 6px 0 var(--hero-navy-dark), 0 0 12px rgba(68,125,247,0.5)';
        }
      }}
      onMouseDown={(e) => {
        if (!disabled) {
