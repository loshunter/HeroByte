...
export const RollLog: React.FC<RollLogProps> = ({ rolls, onClearLog, onViewRoll }) => {
  return (
    <DraggableWindow
      ...
      zIndex={999}
    >
      <JRPGPanel variant="bevel" style={{ padding: '8px', height: '100%', display: 'flex', flexDirection: 'column' }}>
        {/* Clear button */}
        {rolls.length > 0 && (
              ...
              rolls.slice().reverse().map((roll) => (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 0 8px var(--jrpg-border-highlight), inset 0 0 0 1px var(--jrpg-border-shadow), 0 2px 0 var(--jrpg-border-shadow)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = 'var(--jrpg-border-gold)';
                    e.currentTarget.style.boxShadow = 'inset 0 0 0 1px var(--jrpg-border-shadow), 0 2px 0 var(--jrpg-border-shadow)';
                  }}
                >
