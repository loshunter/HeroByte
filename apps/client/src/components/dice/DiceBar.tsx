  ...
  return (
    ...
    >
      ...
      {DICE.map((die) => (
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 6px 0 var(--hero-navy-dark), 0 0 12px rgba(255,255,255,0.3)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = '0 4px 0 var(--hero-navy-dark), 0 0 8px rgba(0,0,0,0.3)';
          }}
          onMouseDown={(e) => {
      ...
      <div
        style={{
          width: '2px',
          background: 'linear-gradient(180deg, transparent 0%, var(--hero-gold) 50%, transparent 100%)',
          margin: '0 4px',
        }}
      />
      ...
      <button
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.transform = 'translateY(-2px)';
          e.currentTarget.style.boxShadow = '0 6px 0 var(--hero-navy-dark), 0 0 12px rgba(240,226,195,0.5)';
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = 'translateY(0)';
          e.currentTarget.style.boxShadow = '0 4px 0 var(--hero-navy-dark), 0 0 8px rgba(0,0,0,0.3)';
      ...
      >
        <div style={{ fontSize: '24px', fontWeight: 'bold', color: 'var(--hero-navy-dark)' }}>+1</div>
      </button>
      ...
      <button
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.transform = 'translateY(-2px)';
          e.currentTarget.style.boxShadow = '0 6px 0 var(--hero-navy-dark), 0 0 12px rgba(136,136,136,0.5)';
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = 'translateY(0)';
          e.currentTarget.style.boxShadow = '0 4px 0 var(--hero-navy-dark), 0 0 8px rgba(0,0,0,0.3)';
