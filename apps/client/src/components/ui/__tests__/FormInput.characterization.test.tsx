...
describe("FormInput - Characterization", () => {
  ...
  describe("props override", () => {
    it("custom placeholder", () => {
      render(<FormInput label="Test" value="" onChange={vi.fn()} placeholder="Enter text here" />);
      const input = screen.getByRole("textbox");
  ...
  describe("real-world patterns", () => {
    ...
    it("NPCEditor portrait URL pattern (text, onBlur)", () => {
      ...
      const onBlur = vi.fn();
      render(
        <FormInput label="Portrait URL" type="text" value="" onChange={onChange} onBlur={onBlur} />,
      );
