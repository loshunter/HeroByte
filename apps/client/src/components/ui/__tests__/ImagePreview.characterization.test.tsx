...
describe("ImagePreview - Characterization", () => {
  ...
  describe("custom sizing", () => {
    ...
    it("maxHeight override (100px portrait variant)", () => {
      render(<ImagePreview src="https://example.com/image.jpg" alt="test" maxHeight="100px" />);
      const img = screen.getByAltText("test");
    ...
    it("custom objectFit: contain", () => {
      render(<ImagePreview src="https://example.com/image.jpg" alt="test" objectFit="contain" />);
      const img = screen.getByAltText("test");
      expect(img).toHaveStyle({ objectFit: "contain" });
    });

    it("custom alignSelf: center", () => {
      render(<ImagePreview src="https://example.com/image.jpg" alt="test" alignSelf="center" />);
      const img = screen.getByAltText("test");
  ...
  describe("error handling", () => {
    ...
    it("onLoadError callback called when image fails to load", () => {
      ...
      render(
        <ImagePreview src="https://example.com/broken.jpg" alt="test" onLoadError={onLoadError} />,
      );
      const img = screen.getByAltText("test");
    ...
    it("onLoadError callback NOT called on successful load", () => {
      const onLoadError = vi.fn();
      render(
        <ImagePreview src="https://example.com/image.jpg" alt="test" onLoadError={onLoadError} />,
      );
    ...
    it("error state persists after re-render", () => {
      const { rerender } = render(<ImagePreview src="https://example.com/broken.jpg" alt="test" />);
      const img = screen.getByAltText("test");
  ...
  describe("edge cases", () => {
    ...
    it("src that changes after initial render", () => {
      const { rerender } = render(<ImagePreview src="https://example.com/image1.jpg" alt="test" />);
  ...
  describe("accessibility", () => {
    it("maintains alt text for screen readers", () => {
      render(<ImagePreview src="https://example.com/image.jpg" alt="Detailed description" />);
