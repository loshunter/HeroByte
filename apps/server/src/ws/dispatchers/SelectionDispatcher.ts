...
export class SelectionDispatcher {
  ...
  dispatch(
    ...
    switch (message.t) {
      case "select-object":
        return this.handler.handleSelectObject(
          state,
          senderUid,
          message.uid,
          message.objectId
      ...
      case "select-multiple":
        return this.handler.handleSelectMultiple(
          state,
          senderUid,
          message.uid,
          message.objectIds,
      ...
      case "lock-selected":
        return this.handler.handleLockSelected(
          state,
          senderUid,
          message.uid,
          message.objectIds
      ...
      case "unlock-selected":
        return this.handler.handleUnlockSelected(
          state,
          senderUid,
          message.uid,
          message.objectIds
