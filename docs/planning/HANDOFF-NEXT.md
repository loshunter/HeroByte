...
| Branch | Commit     | State                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `dev`  | `41df84a6` | docs commits ahead of `main`, pushed through `41df84a6`; local docs commits since (2026-08-31): CI #830/#832 read (both success), `recordManual` reconciled, and **the Atlas arc plan authored, adversarially reviewed (4 lenses; 2 BLOCKERs + 10 HIGHs folded in), and at Rev 2 — [atlas-arc-plan.md](./atlas-arc-plan.md) is the execution spec; start at its §0.** [PROMPT-atlas-arc.md](./PROMPT-atlas-arc.md) stays the mission context (its “documents fetch over HTTP” claim is REFUTED — plan §2.1). CI **#829** green at the pushed sha |
